  ...
  return (
    <div className="space-y-4 my-8 z-0">
      ...
      <section className="mb-4">
        <h3 className="font-bold">1. 目的</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">2. 取り扱う個人情報の範囲</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">3. 利用目的</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">4. 個人情報の保管期間・廃棄</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">5. 情報の管理措置</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">6. 第三者提供の制限</h3>
        <p className="ml-4">
      ...
      <section className="mb-4">
        <h3 className="font-bold">8. 規約の改定</h3>
        <p className="ml-4">
